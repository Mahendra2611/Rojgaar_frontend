  ...
  return (
    <StyledWrapper>
      <div className="social-buttons">
        <Link to="https://github.com/Mahendra2611" className="social-button github">
        ...
        <Link to="https://www.linkedin.com/in/mahendra-pratap-verma-559b81257" className="social-button linkedin">
        ...
        <Link to="https://www.facebook.com"  className="social-button facebook">
        ...
        <Link to="https://www.instagram.com/mahendra_123.p" className="social-button instagram">
