...
const Home= () => {
 ...
 useEffect(() => {
  ...
  <div className="flex flex-wrap justify-center w-full gap-6 p-6 ">
      <PageCard title="Jobs" path="/user/jobs" bgColor="bg-gradient-to-r from-blue-500 to-indigo-500" />
      <PageCard title="Internship" path="/user/intern" bgColor="bg-gradient-to-r from-green-400 to-teal-500" />
      <PageCard title="Resume" path="/user/resume" bgColor="bg-gradient-to-r from-purple-500 to-pink-500" />
    </div>
